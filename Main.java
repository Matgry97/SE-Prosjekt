...
public class Main {
	...
	billett kinoaalesund = new billett("legofilmen", "Ålesund kino", 2, 3, 12, 150.50, "15:30", LocalDate.of(2014,3,3));

        Person Daggy = new Person ("Dag", "Eirik", 30, kinoaalesund);

        System.out.println(Daggy);
    }
